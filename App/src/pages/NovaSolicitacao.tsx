...
export const NovaSolicitacao: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 w-full overflow-x-hidden">
      ...
      <div className="bg-gradient-to-r from-green-700 via-green-600 to-green-800 text-white px-4 pt-10 pb-4 sticky top-0 z-30 shadow-md">
      ...
      {currentStep >= 1 && currentStep <= 6 && (
        <div className="p-4 bg-white border-b border-slate-200 shadow-sm sticky top-[88px] z-20">
          <div className="relative flex items-center bg-slate-50 rounded-2xl border border-slate-200 px-3 py-2.5 focus-within:bg-white focus-within:border-green-600 focus-within:ring-2 focus-within:ring-green-500/20 transition-all">
            <div className="w-8 h-8 rounded-lg bg-green-50 text-green-700 flex items-center justify-center mr-3 shrink-0">
              <Search size={18} />
            </div>
            <input 
              type="text"
      ...
      <div className="flex-1 bg-white">
              ...
              return (
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 rounded-xl bg-green-100 text-green-700 flex items-center justify-center shrink-0 group-hover:bg-green-600 group-hover:text-white transition-colors">
                      <IconeCat size={22} />
                    </div>
                    <div>
                      <h4 className="text-base font-bold text-slate-800 group-hover:text-green-900">
                        {cat.nome}
                      </h4>
                  ...
                  <ChevronRight size={20} className="text-slate-400 group-hover:text-green-600 group-hover:translate-x-1 transition-all shrink-0" />
                </div>
              );
            })}
          </div>
        ...
        {currentStep === 4 && (
          <div className="divide-y divide-slate-100">
            <div className="bg-green-50 px-5 py-2.5 text-xs font-bold text-green-800 uppercase tracking-wide border-b border-green-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input 
                      type="date" 
                      required
                      className="w-full border border-slate-300 rounded-xl px-3 py-2.5 text-sm font-semibold text-slate-800 shadow-sm focus:ring-2 focus:ring-green-500"
              ...
              <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm space-y-2">
                ...
                <textarea
                  ...
                  className="w-full border border-slate-300 rounded-xl px-3 py-2.5 text-sm focus:ring-2 focus:ring-green-500 resize-none shadow-sm font-medium"
                  value={observacoes}
              ...
              <div className="pt-3 flex items-center justify-end space-x-3">
                ...
                <button
                  ...
                  className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-xl font-bold transition-all shadow-lg shadow-green-700/20 flex items-center text-sm disabled:opacity-50"
                >
                  {isLoading ? (
