...
export const Splash: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-emerald-600 h-full">
      ...
      <p className="text-emerald-200 mt-2 font-medium uppercase tracking-widest text-sm">Logística</p>
    </div>
  );
};
